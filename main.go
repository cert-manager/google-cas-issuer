...
func init() {
	...
	_ = issuersv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "cd7f7f35.jetstack.io",
	})
	if err != nil {
	...
	if err = (&controllers.GoogleCASIssuerReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("GoogleCASIssuer"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "GoogleCASIssuer")
		os.Exit(1)
	}
	if err = (&controllers.GoogleCASClusterIssuerReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("GoogleCASClusterIssuer"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
