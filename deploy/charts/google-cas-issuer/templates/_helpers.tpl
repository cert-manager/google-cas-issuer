...
{{- if ne (len .) 4 -}}
    {{- fail (printf "ERROR: template \"cert-manager-google-cas-issuer.image\" expects (tuple <imageValues> <imageRegistry> <imageNamespace> <defaultReference>), got %d arguments" (len .)) -}}
{{- end -}}
